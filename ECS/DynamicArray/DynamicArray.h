...
public:
	...
	DynamicArray<Type>(const DynamicArray<Type>& other) noexcept;
	DynamicArray<Type>(DynamicArray<Type>&& other) noexcept;
	DynamicArray<Type>& operator=(const DynamicArray<Type>& other) noexcept;
