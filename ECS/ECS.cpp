...
#ifdef CUSTOMECS
	ECS::Registry ECS{ TestInitECS(AmountOfEntities) };
#endif
#ifdef GAMEOBJECT
	std::vector<GO::GameObject*> gameObjects{ TestInitGO(AmountOfEntities) };
#endif
#ifdef ENTT
	entt::registry entt{ TestInitENTT(AmountOfEntities) };
#endif
